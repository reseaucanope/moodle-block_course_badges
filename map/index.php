...
foreach($participantslist AS $participant)
{
    ...
    // avatar column
    $picture_url = $OUTPUT->user_picture($participant, array('size' => 50, 'popup' => true));
    $popup .= html_writer::start_tag('td', ['style' => 'width: 50px; padding: 0 5px 0 0;vertical-align: initial']);
    $img = html_writer::img($picture_url, '', ['height' => '50px']);
    $popup .= $picture_url;
    $popup .= html_writer::end_tag('td');

    $popup .= html_writer::start_tag('td', ['style' => 'padding:0;']);
    ...
    $popup .= html_writer::div(' |', '', ['style' =>  'color:#999;display: inline;']);
